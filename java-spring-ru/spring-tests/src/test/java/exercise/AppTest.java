...
public class AppTest {
    ...
    void testPatchPerson() throws Exception {
        ...
        MockHttpServletResponse firstResponse = mockMvc
                .perform(patch("/people/" + existingUserId)
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"first_name\": \"1\", \"last_name\": \"2\", \"email\": \"3\"}"))
                .andReturn()
                .getResponse();

        assertThat(firstResponse.getStatus()).isEqualTo(200);
        assertNull(repository.findByEmail("jack@mail.com"));
        assertNotNull(repository.findByEmail("3"));
    }
